    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               //Intent i = new Intent(SelectIngredient.this,MealDetailsActivity.class);
               startActivity(i);
                finish();
...
*/
    ...
    private void loadActivities() {
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            Allingredients adapter = new Allingredients(SelectIngredient.this ,R.layout.ingredient_list,lstcc );
                            ...
                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
                                    ...
                                    Intent i = new Intent(SelectIngredient.this, addToMealActivity.class);
        ...
        Volley.newRequestQueue(SelectIngredient.this).add(stringRequest);
    ...
    public void searchByName(){
        ...
        if(s.length() > 0) {
            ...
            Allingredients adapter = new Allingredients(SelectIngredient.this, R.layout.ingredient_list, lstcs);
            adapter.notifyDataSetChanged();
            listView.setAdapter(adapter);
        }else{
            Allingredients adapter = new Allingredients(SelectIngredient.this, R.layout.ingredient_list, lstcc);
